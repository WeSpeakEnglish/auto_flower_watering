...
Auto flower watering simple system, based on Cytron Maker Mousture sensor and ultracheap WeAct STM32G031F8P6 module. Middle power consumplion as for now cca 5mA. With LiIon accu. 1350mA stay cca. 10 days. (may be imroved by adding additional switch for the sensor, and sleep mode intro into MCU code), this was 1 day setup and not optimized now.
